...
- When you consult graphify during a task, say so — state the query and a one-line summary of what it returned, so its use is visible in the transcript, not silent.
