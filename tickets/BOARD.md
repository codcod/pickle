...
|---|---|---|
| T-051 | surface the workspace-side consequences of registering a child-project | review: 2 blocking (F2 unusable advice for ./x paths, F3 non-repo child mislabelled) |
