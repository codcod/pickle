...
|---|---|---|
| T-125 | a blocking finding first surfacing after step 6b has no defined route in the protocol | 1 blocking (V1): the R3 join clause contradicts batch-by-theme |
...
| T-126 | Ticket cycle-time / lead-time report mined from each ticket's dated History lines | medium | medium | M | [] |  |
