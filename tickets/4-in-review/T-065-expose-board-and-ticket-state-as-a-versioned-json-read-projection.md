...
- [x] Summary presented; no publish (blocking finding — nothing to push) (step 9)
...
this branch authored), 2 *noted* (F5 a pre-existing acceptance-check defect, F6 a test gap). No
follow-up ticket: none passes the promotion test, and F1 is a five-line fix on the same branch.
